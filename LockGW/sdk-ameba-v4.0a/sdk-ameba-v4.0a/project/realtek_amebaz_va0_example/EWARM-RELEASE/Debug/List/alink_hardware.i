#line 1 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\application\\alink2.0\\platform\\alink_hardware.c"
...
#line 45 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\application\\alink2.0\\platform\\alink_hardware.c"
...
#line 47 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\application\\alink2.0\\platform\\alink_hardware.c"

#line 1 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\project\\realtek_amebaz_va0_example\\EWARM-RELEASE\\..\\..\\..\\component\\common\\mbed\\hal_ext\\wdt_api.h"
...
#line 49 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\application\\alink2.0\\platform\\alink_hardware.c"
#line 1 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\project\\realtek_amebaz_va0_example\\EWARM-RELEASE\\..\\..\\..\\component\\common\\mbed\\hal_ext\\sys_api.h"
...
#line 115 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\project\\realtek_amebaz_va0_example\\EWARM-RELEASE\\..\\..\\..\\component\\common\\mbed\\hal_ext\\sys_api.h"
...
#line 50 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\application\\alink2.0\\platform\\alink_hardware.c"

#line 58 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\application\\alink2.0\\platform\\alink_hardware.c"
...
char *platform_wifi_get_mac(char mac_str[(17 + 1)])
{
	...
	rtl_sprintf((char *)mac_str,"%02X:%02X:%02X:%02X:%02X:%02X",mac[0],mac[1],mac[2],mac[3],mac[4],mac[5]);
	return mac_str;
}
...
uint32_t platform_wifi_get_ip(char ip_str[(15 + 1)],  const char *ifname)
{
	...
	char ifname_buff[16] = "wlan0";


	if((0 == ifname || prvStrLen((const unsigned char *) ifname) == 0) ){
		ifname = ifname_buff;
	}
	...
	ip[2] = tmp[2];
	ip[3] = tmp[3];
	rtl_sprintf((char *)ip_str,"%d.%d.%d.%d",ip[0],ip[1],ip[2],ip[3]);
	ip_addr = ipaddr_addr(ip_str);
	return ip_addr;
}

char *platform_get_chipid(char chipid[(64 + 1)])
{
	...
	const char *dev_chipid = "rtl8188eu 12345678";
	int length;
	length = (((64 + 1)-1)> prvStrLen((const unsigned char *) dev_chipid)) ? prvStrLen((const unsigned char *) dev_chipid) : ((64 + 1) -1);
	_memcpy(chipid, dev_chipid, length);
	chipid[length] = '\0';

	return chipid;
}

char *platform_get_os_version(char os_ver[(32)])
{
	const char *softver = "rtl-amebaz-sdk-v4.0-05";
	int length;
	length = (((32)-1)> prvStrLen((const unsigned char *) softver)) ? prvStrLen((const unsigned char *) softver) : ((32)-1);
	_memcpy(os_ver, softver, length);
	os_ver[length] = '\0';
	do { if (2 <= 2) { if (2 <= 0) { rtl_printf("\r\nERROR: " "[%s] RealTek SDK version: %s\n",__FUNCTION__, os_ver); } else { rtl_printf("\r\n" "[%s] RealTek SDK version: %s\n",__FUNCTION__, os_ver); } }}while(0);
	return os_ver;
}
...
int platform_config_write(const char *buffer, int length)
{
	...
	flash_erase_sector(&flash_config, 0x000FC000);
	ret = flash_stream_write(&flash_config, 0x000FC000, length, (uint8_t *)buffer);
	device_mutex_unlock(RT_DEV_LOCK_FLASH);

	if(-1 == ret) {
		rtl_printf("%s(): " "write open file fail" "\n", __FUNCTION__);;
		return (-1);
	}
	do { if (2 <= 2) { if (2 <= 0) { rtl_printf("\r\nERROR: " "[%s] write config successful, ret = %d\n",__FUNCTION__, ret); } else { rtl_printf("\r\n" "[%s] write config successful, ret = %d\n",__FUNCTION__, ret); } }}while(0);
	return (0);
}
...
int platform_config_read(char *buffer, int length)
{
	...
	device_mutex_lock(RT_DEV_LOCK_FLASH);
	ret = flash_stream_read(&flash_config, 0x000FC000, length, (uint8_t *)buffer);
	device_mutex_unlock(RT_DEV_LOCK_FLASH);
	if(-1 == ret)
	{
		rtl_printf("%s(): " "read open file fail" "\n", __FUNCTION__);;
		return (-1);
	}
	do { if (2 <= 2) { if (2 <= 0) { rtl_printf("\r\nERROR: " "[%s] %d\n",__FUNCTION__, ret); } else { rtl_printf("\r\n" "[%s] %d\n",__FUNCTION__, ret); } }}while(0);
	return (0);
...
int platform_sys_net_is_ready(void)
{
	...
	if ((ip[0] == 192 && ip[1] == 168 && ip[2] == 1 && ip[3] == 80)
		...
		do { if (3 <= 2) { if (3 <= 0) { rtl_printf("\r\nERROR: " "[%s] Network is not ready, ret = 0\n",__FUNCTION__); } else { rtl_printf("\r\n" "[%s] Network is not ready, ret = 0\n",__FUNCTION__); } }}while(0); 
	} else if(RTW_SUCCESS == wifi_is_connected_to_ap( )) {
		do { if (3 <= 2) { if (3 <= 0) { rtl_printf("\r\nERROR: " "[%s] Network is ready, ret = 1\n",__FUNCTION__); } else { rtl_printf("\r\n" "[%s] Network is ready, ret = 1\n",__FUNCTION__); } }}while(0); 		
		return 1;
	} 
	return 0;
}
...
{
	do { if (2 <= 2) { if (2 <= 0) { rtl_printf("\r\nERROR: " "Reboot alink !!!\r\n"); } else { rtl_printf("\r\n" "Reboot alink !!!\r\n"); } }}while(0);
	((*((volatile uint32_t*)(0x40000000 + 0x0210))) = ((uint32_t)((((uint32_t)(*((volatile uint32_t*)(0x40000000 + 0x0210))))&(~0x08000000)))));
...
char *platform_get_module_name(char name_str[(32)])
{
	const char *module = "RTL8710BN";
	int length;
	_memset(name_str, 0, (32));
	length = (((32)-1)> prvStrLen((const unsigned char *) module)) ? prvStrLen((const unsigned char *) module) : ((32) -1);
	_memcpy(name_str, module, length);
	name_str[length] = '\0';
	do { if (2 <= 2) { if (2 <= 0) { rtl_printf("\r\nERROR: " "[%s] RealTek Module type: %s\n",__FUNCTION__, name_str); } else { rtl_printf("\r\n" "[%s] RealTek Module type: %s\n",__FUNCTION__, name_str); } }}while(0);
	return name_str;
}
