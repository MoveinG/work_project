#line 1 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\example\\ssl_download\\example_ssl_download.c"
...
#line 2 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\example\\ssl_download\\example_ssl_download.c"
...
#line 3 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\example\\ssl_download\\example_ssl_download.c"
...
#line 4 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\example\\ssl_download\\example_ssl_download.c"
...
#line 6 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\example\\ssl_download\\example_ssl_download.c"
...
#line 10 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\example\\ssl_download\\example_ssl_download.c"
...
#line 11 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\example\\ssl_download\\example_ssl_download.c"
...
#line 12 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\example\\ssl_download\\example_ssl_download.c"
...
#line 13 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\example\\ssl_download\\example_ssl_download.c"
...
static void example_ssl_download_thread(void *param)
{
	...
	if((ret = net_connect(&server_fd, "176.34.62.248", 443)) != 0) {
		rtl_printf("ERROR: net_connect ret(%d)\n", ret);
		goto exit;
	}

	if((ret = ssl_init(&ssl)) != 0) {
		rtl_printf("ERRPR: ssl_init ret(%d)\n", ret);
		goto exit;
	}
	...
	if((ret = ssl_handshake(&ssl)) != 0) {
		rtl_printf("ERROR: ssl_handshake ret(-0x%x)", -ret);
		goto exit;
	}
	else {
		...
		rtl_printf("SSL ciphersuite %s\n", ssl_get_ciphersuite(&ssl));
		rtl_sprintf(buf, "GET %s HTTP/1.1\r\nHost: %s\r\n\r\n", "/repository/IOT/Project_Cloud_A.bin", "176.34.62.248");
		ssl_write(&ssl, buf, prvStrLen((const unsigned char *) buf));

		while((read_size = ssl_read(&ssl, buf, 2048)) > 0) {
			if(header_removed == 0) {
				char *header = 0;

				buf[read_size] = 0;
				header = prvStrStr(buf, "\r\n\r\n");

				if(header) {
					char *body, *content_len_pos;

					body = header + prvStrLen((const unsigned char *) "\r\n\r\n");
					*(body - 2) = 0;
					header_removed = 1;
					rtl_printf("\nHTTP Header: %s\n", buf);
					...
					content_len_pos = prvStrStr(buf, "Content-Length: ");
					if(content_len_pos) {
						content_len_pos += prvStrLen((const unsigned char *) "Content-Length: ");
						*(char*)(prvStrStr(content_len_pos, "\r\n")) = 0;
						content_len = prvAtoi(content_len_pos);
					}
				}
				else {
					rtl_printf("ERROR: HTTP header\n");
					goto exit;
				}
			}

			rtl_printf("read resource %d bytes\n", read_size);
			resource_size += read_size;
		}

		rtl_printf("exit read. ret = %d\n", read_size);
		rtl_printf("http content-length = %d bytes, download resource size = %d bytes\n", content_len, resource_size);
	}
...
{
	if(xTaskGenericCreate( ( example_ssl_download_thread ), ( ((const char*)"example_ssl_download_thread") ), ( 2048 ), ( 0 ), ( ( ( UBaseType_t ) 0U ) + 1 ), ( 0 ), ( 0 ), ( 0 ) ) != ( ( ( BaseType_t ) 1 ) ))
