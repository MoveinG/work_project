#line 1 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\example\\http_download\\example_http_download.c"
...
#line 2 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\example\\http_download\\example_http_download.c"
...
#line 3 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\example\\http_download\\example_http_download.c"
...
#line 4 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\example\\http_download\\example_http_download.c"
...
#line 5 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\example\\http_download\\example_http_download.c"
...
#line 6 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\example\\http_download\\example_http_download.c"
...
static void example_http_download_thread(void *param)
{
	...
	if((server_fd = lwip_socket(2,1,0)) < 0) {
		rtl_printf("ERROR: socket\n");
		goto exit;
	}
	else {
		int recv_timeout_ms = 5000;
#line 35 "E:\\Lock-GW\\project\\00007829-sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\sdk-ameba-v4.0a\\component\\common\\example\\http_download\\example_http_download.c"
		lwip_setsockopt(server_fd,0xfff,0x1006,&recv_timeout_ms,sizeof(recv_timeout_ms));
	...
	server_host = lwip_gethostbyname("176.34.62.248");
	_memcpy((void *) &server_addr . sin_addr, (void *) server_host->h_addr_list[0], server_host->h_length);

	if(lwip_connect(server_fd,(struct sockaddr *) &server_addr,sizeof(server_addr)) == 0) {
		...
		lwip_write(server_fd,buf,prvStrLen((const unsigned char *) buf));

		while((read_size = lwip_read(server_fd,buf,2048)) > 0) {
			if(header_removed == 0) {
				char *header = 0;
...
{
	if(xTaskGenericCreate( ( example_http_download_thread ), ( ((const char*)"example_http_download_thread") ), ( 2048 ), ( 0 ), ( ( ( UBaseType_t ) 0U ) + 1 ), ( 0 ), ( 0 ), ( 0 ) ) != ( ( ( BaseType_t ) 1 ) ))
