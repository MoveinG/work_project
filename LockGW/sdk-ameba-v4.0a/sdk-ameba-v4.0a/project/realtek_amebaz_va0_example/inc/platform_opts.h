...
#define CONFIG_PLATFORM_AMEBAZ 1
/******************************************************************************/
...
#if CONFIG_PLATFORM_AMEBAZ
#define FAST_RECONNECT_DATA 	        0x000FE000//(0x80000 - 0x1000)
#else
...
#define CONFIG_ALINK			1//on or off for alibaba alink
