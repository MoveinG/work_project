 ...
 */
#ifndef _ALINK__PLATFORM_H__
#define _ALINK__PLATFORM_H__
...
#define CONFIG_DATA_ADDRESS		0x000FC000
#define CONFIG_DEVICE_INFO		0x000FD000	// 4KB flash space for device key&&secret
#define BUTTON  PA_0
#else
#define CONFIG_DATA_ADDRESS		((0x100000) - (0x1000))
#define CONFIG_DEVICE_INFO		((0x100000) - (0x2000))	// 4KB flash space for device key&&secret
#define BUTTON  PC_5
#endif
...
#define PLATFORM_SOCKET_MAXNUMS			(8)//(10)
...
#define CONFIG_GPIO_TASK

void get_ap_bssid(IN char * target_ssid, IN int target_ssid_len, OUT uint8 wifi_bssid[6]);
